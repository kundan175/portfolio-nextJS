...
const about = {
  title: "About me",
  description:
    "I’m a full-stack developer with expertise in React Native, React.js, Next.js, and Node.js. I excel in crafting dynamic web and mobile applications, leveraging my skills in HTML, CSS, and Tailwind CSS to create visually appealing and responsive designs. Passionate about building efficient, scalable solutions and staying up-to-date with the latest technologies.",
  info: [
    {
      fieldName: "Name",
      fieldValue: "Kundan Kumar",
    },
    {
      fieldName: "Phone",
      fieldValue: "(+91) 9576322595",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "kundansingh957632@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  items: [
    {
      company: "Makemeglobal (MMG)",
      link: "https://www.makemeglobal.org/",
      position: "Full Stack Developer - Full Time",
      duration: "Jul 2024 - to present",
    },
    {
      company: "Netset Software Solutions",
      link: "https://www.netsetsoftware.com/",
      position: "Front Developer - Full Time",
